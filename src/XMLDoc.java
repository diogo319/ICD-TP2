...
final public class XMLDoc {
    ...
    public static final void StartSerialization(final Document DOMtree, final String targetFileName) {
		/*
		 * demonstração da funcionalidade save da arvore DOM alternativa ao uso
		 * da transformação vazia
		 */
	...
	/**
	 * Validação de documento em ficheiro com XSD ou DTD conforme o indicado no parametro type
	 * @param xmlFileName
	 * @param vFileName
	...
	/**
	 * Validação de documento na árvore DOM, com XSD ou DTD conforme o indicado no parametro type
	 * @param document
	 * @param xsdFileName 
	 * @param type XMLConstants.W3C_XML_SCHEMA_NS_URI ou XMLConstants.XML_DTD_NS_URI
	...
	public static void main(String[] args) {
		...
		if (validDocDTD(xmlFileName, dtdFileName))
			System.out.println("Validação com DTD realizada com sucesso!");
		else
			System.out.println("Falhou a validação com DTD ("+xsdFileName+")!");
