...
public class RemoverPeca extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<tr><td style='border: none; background: white;'></td><td style='border: none; background: white;'></td><td style='border: none; background: white;'></td><td style='border: none; background: white;'></td><th>Total</th><td>" + total + " &euro;" + "</td></tr>");
		out.println("</table>");
		out.println("</form>'");
